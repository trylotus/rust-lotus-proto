...
//! Generated file from `lotus/staking/delegation.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_0;

// @@protoc_insertion_point(message:lotus.staking.Delegation)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Delegation {
    // message fields
    // @@protoc_insertion_point(field:lotus.staking.Delegation.timestamp)
    pub timestamp: ::protobuf::MessageField<::protobuf::well_known_types::timestamp::Timestamp>,
    // @@protoc_insertion_point(field:lotus.staking.Delegation.delegator_address)
    pub delegator_address: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:lotus.staking.Delegation.validator_address)
    pub validator_address: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:lotus.staking.Delegation.amount)
    pub amount: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:lotus.staking.Delegation.special_fields)
...
impl Delegation {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, ::protobuf::well_known_types::timestamp::Timestamp>(
            "timestamp",
            |m: &Delegation| { &m.timestamp },
            |m: &mut Delegation| { &mut m.timestamp },
        ));
...
impl ::protobuf::Message for Delegation {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    self.delegator_address = is.read_bytes()?;
                },
                26 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.delegator_address.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.delegator_address);
        }
        if !self.validator_address.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.validator_address);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.delegator_address.is_empty() {
            os.write_bytes(2, &self.delegator_address)?;
        }
        if !self.validator_address.is_empty() {
            os.write_bytes(3, &self.validator_address)?;
        }
        if !self.amount.is_empty() {
    ...
    fn default_instance() -> &'static Delegation {
        static instance: Delegation = Delegation {
            ...
            delegator_address: ::std::vec::Vec::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1elotus/staking/delegation.proto\x12\rlotus.staking\x1a\x1fgoogle/pr\
    otobuf/timestamp.proto\x1a\x11lotus/lotus.proto\"\xce\x01\n\nDelegation\
    \x128\n\ttimestamp\x18\x01\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\
    \ttimestamp\x123\n\x11delegator_address\x18\x02\x20\x01(\x0cR\x10delegat\
    orAddressB\x06\xd2\xab0\x02\x08\x01\x123\n\x11validator_address\x18\x03\
    \x20\x01(\x0cR\x10validatorAddressB\x06\xd2\xab0\x02\x08\x01\x12\x1c\n\
    \x06amount\x18\x04\x20\x01(\tR\x06amountB\x04\xda\xab0\0B,Z*github.com/t\
    rylotus/go-lotus-proto/stakingJ\x9a\x03\n\x06\x12\x04\0\0\x0e\x01\n\x08\
    ...
    \x12\x03\n()\n\x0b\n\x04\x04\0\x02\x01\x12\x03\x0b\x02G\n\x0c\n\x05\x04\
    \0\x02\x01\x05\x12\x03\x0b\x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\
    \x0b\x08\x19\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x0b\x1c\x1d\n\x0c\n\
    \x05\x04\0\x02\x01\x08\x12\x03\x0b\x1eF\n\x10\n\t\x04\0\x02\x01\x08\xba\
    \x85\x06\x01\x12\x03\x0b\x1fE\n\x0b\n\x04\x04\0\x02\x02\x12\x03\x0c\x02G\
    \n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03\x0c\x02\x07\n\x0c\n\x05\x04\0\x02\
    \x02\x01\x12\x03\x0c\x08\x19\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x0c\
    \x1c\x1d\n\x0c\n\x05\x04\0\x02\x02\x08\x12\x03\x0c\x1eF\n\x10\n\t\x04\0\
    \x02\x02\x08\xba\x85\x06\x01\x12\x03\x0c\x1fE\n\x0b\n\x04\x04\0\x02\x03\
    \x12\x03\r\x02+\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03\r\x02\x08\n\x0c\n\
    \x05\x04\0\x02\x03\x01\x12\x03\r\t\x0f\n\x0c\n\x05\x04\0\x02\x03\x03\x12\
    \x03\r\x12\x13\n\x0c\n\x05\x04\0\x02\x03\x08\x12\x03\r\x14*\n\x0f\n\x08\
    \x04\0\x02\x03\x08\xbb\x85\x06\x12\x03\r\x15)b\x06proto3\
";
